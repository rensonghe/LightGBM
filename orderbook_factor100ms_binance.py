...
schema_depth = pa.schema([
    ('closetime', pa.float64()),
    ('ask_price1', pa.float64()),('ask_size1', pa.float64()),('bid_price1', pa.float64()),('bid_size1', pa.float64()),
    ('ask_price2', pa.float64()),('ask_size2', pa.float64()),('bid_price2', pa.float64()),('bid_size2', pa.float64()),
    ('ask_price3', pa.float64()),('ask_size3', pa.float64()),('bid_price3', pa.float64()),('bid_size3', pa.float64()),
    ('ask_price4', pa.float64()),('ask_size4', pa.float64()),('bid_price4', pa.float64()),('bid_size4', pa.float64()),
    ('ask_price5', pa.float64()), ('ask_size5', pa.float64()),('bid_price5', pa.float64()),('bid_size5', pa.float64()),
    ('ask_price6', pa.float64()), ('ask_size6', pa.float64()), ('bid_price6', pa.float64()),('bid_size6', pa.float64()),
    ('ask_price7', pa.float64()), ('ask_size7', pa.float64()), ('bid_price7', pa.float64()),('bid_size7', pa.float64()),
    ('ask_price8', pa.float64()), ('ask_size8', pa.float64()), ('bid_price8', pa.float64()),('bid_size8', pa.float64()),
    ('ask_price9', pa.float64()), ('ask_size9', pa.float64()), ('bid_price9', pa.float64()),('bid_size9', pa.float64()),
    ('ask_price10', pa.float64()), ('ask_size10', pa.float64()), ('bid_price10', pa.float64()),('bid_size10', pa.float64()),
    ('symbol', pa.string()),
    ('year', pa.int64()),
    ('month', pa.int64())
])
